...
public final class KKDeviceSystemInfo {
    ...
    public static var system_device_type_formatted_name: String {
        ...
        return name ?? system_device_type
    }
    ...
    private static let device_model_list = [
        ...
        ["modelName": "iPhone19,2", "formatted": "iPhone 18 Pro"],
        ["modelName": "iPhone19,3", "formatted": "iPhone 18 Pro Max (USA)"],
        ["modelName": "iPhone19,4", "formatted": "iPhone Duo"],
        ["modelName": "iPhone19,7", "formatted": "iPhone 18 Pro Max"],
